"use strict";
function createGalleryElement(title, linkType, link, poster) {
...
createGalleryElement("vending machine (animation)", "video", "./media/vendbreak2.mp4", "./media/vend.png");
createGalleryElement("circuit board (turntable)", "video", "./media/cboard.mp4", "./media/cboard_render02.png");
createGalleryElement("psiprofen (turntable)", "video", "./media/psiprofen.mp4", "./media/psiprofen_render01.png");
createGalleryElement("water flask (turntable)", "video", "./media/water.mp4", "./media/water_render01.png");
createGalleryElement("cgi test scene (animation)", "video", "./media/cgitest002.mp4", "./media/cgitest002.png");
createGalleryElement("tomoko (fan art)", "image", "./media/tomoko.png", "");
